...
tfstate_rg_name="microservice_demo_tfstate_rg"
tfstate_storage_account_name="microservicedemosa"
tfstate_container_name="microservice-demo-tfstate-c"
tfstate_key="microservice_demo.tfstate"
